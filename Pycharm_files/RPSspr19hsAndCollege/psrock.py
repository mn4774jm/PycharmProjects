...
def round_robin(number_of_rounds, *argv):
    ...
    for player1 in argv:
        ...
        for player2 in argv[argv.index(player1)+1:]:
            ...
            report[player2_name] += '\n'+history2 +' '*8 + player2_name + ': '+ strategy_name(player2) + ' '+score1+'\n' + \
    ...
    short_report_file = open('short_rept.csv', 'w', newline = '')
    for team in overall_record:
        ...
        short_report_list = [overall_record[team][0], overall_record[team][1], overall_record[team][2], team, strategy_names[team]]
        short_report_writer = csv.writer(short_report_file)
        short_report_writer.writerow(short_report_list)
    short_report_file.close()
